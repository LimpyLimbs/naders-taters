...
'''
calculating the cost of the order will occur here
the price of the order needs to be a key/value pair in the order anyway
the payments service can just be a dumb endpoint which will only process payments
    payments service will also update the payments service with updated inventory
'''